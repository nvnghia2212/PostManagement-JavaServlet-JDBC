...
<html>
	...
	<body>
		...
		<script>
/* Tất cả đoạn code trong document sẽ chạy đầu tiên khi trang load  */
 			var editor = '';
			$(document).ready(function(){
		/* Sử dụng CKEDITOR để lưu cả các thẻ html cho đoạn nội dung như: xuống dòng, in đậm,... */
